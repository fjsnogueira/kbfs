...
func (md *BareRootMetadataV3) AddNewKeysForTesting(
	prevExtra ExtraMetadata, crypto cryptoPure,
	wDkim, rDkim UserDeviceKeyInfoMap, pubKey kbfscrypto.TLFPublicKey) (
